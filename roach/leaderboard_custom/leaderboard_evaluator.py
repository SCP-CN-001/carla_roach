...
from roach.leaderboard_custom.autoagents.agent_wrapper import AgentError, AgentWrapper
from roach.leaderboard_custom.scenarios.route_scenario import RouteScenario
from roach.leaderboard_custom.scenarios.scenario_manager import ScenarioManager
...
class LeaderboardEvaluator:
    ...
    def _load_and_run_scenario(self, args, config):
        ...
        try:
            args.trafficManagerSeed = int(args.init_trafficManagerSeed) + int(
                config.index
            )
            ...
            self.manager.load_scenario(
                scenario, self.agent_instance, config.repetition_index
            )
    ...
    def run(self, args):
        ...
        route_indexer = RouteIndexer(
            args.routes, args.scenarios, args.repetitions, args.routes_subset
        )
...
def main():
    ...
    parser.add_argument(
        ...
        type=str2bool,
        default=False,
        help="whether in eval mode otherwise data collection mode",
    )
