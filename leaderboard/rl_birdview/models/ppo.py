...
class PPO():
    def __init__(self, policy, env = None,
        ...
        self.n_steps = n_steps_total//envnum_envs
        ...
        # self.observation_space = {'birdview': gym.spaces.Box(15, 192, 192), 'state': gym.spaces.Box(6, )}
        ...
        # self.action_space = gym.spaces.Box(2, )
        self.action_space = gym.spaces.Box(low=-1.0, high=1.0, shape=(2,))
        self.buffer = PpoBuffer(self.n_steps, self.observation_space, self.action_space,
                                gamma=self.gamma, gae_lambda=self.gae_lambda, n_envs=self.envnum_envs)
    ...
    def collect_rollouts(self, env: VecEnv, callback: BaseCallback,
        ...
        while n_steps < 256:#n_rollout_steps
            ...
            n_steps += 1
          #  self.num_timesteps += envnum_envs
    ...
    def learn(self, total_timesteps, callback=None, seed=2021):
        ...
        self._last_obs = self.env.reset()  #这个reset继承的是/home/vci-1/XT/carla_Roach_beifen/carla-roach/carla_gym/carla_multi_agent_env.py
                                            #和/home/vci-1/XT/carla_Roach_beifen/carla-roach/carla_gym/envs/suites/endless_env.py
        #town1环境下：
                    #reset()debug在/home/vci-1/.conda/envs/carla/lib/python3.7/site-packages/stable_baselines3/common/vec_env/dummy_vec_env.py
        #更进一步的是在/home/vci-1/XT/carla_Roach_beifen/carla-roach/agents/rl_birdview/utils/rl_birdview_wrapper.py
        self._last_dones = np.zeros((self.envnum_envs,), dtype=np.bool)
