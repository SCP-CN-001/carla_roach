...
class RlBirdviewWrapper(gym.Wrapper):
    ...
    def reset(self):
        ...
        if self.eval_mode:
            ...
            '''
            self.env._ev_handler._terminal_configs
            Out[2]: 
            {'hero': {'entry_point': 'terminal.valeo_no_det_px:ValeoNoDetPx',
        ...
        obs_ma, _, _, _ = self.env.step(action_ma)#/home/vci-1/XT/carla_Roach_beifen/carla-roach/carla_gym/carla_multi_agent_env.py
