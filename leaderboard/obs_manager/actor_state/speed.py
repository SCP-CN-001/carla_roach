...
class ObsManager_speed(ObsManagerBase):
    """
    in m/s
    """
    ...
    def __init__(self, obs_configs,ego_vehicles):
        ...
        super(ObsManager_speed, self).__init__()
    ...
    def get_observation(self):
        ...
        velocity = self.ego_vehicles.get_velocity()
        transform = self.ego_vehicles.get_transform()
