...
class ObsManager_control(ObsManagerBase):
    ...
    def get_observation(self):
      ...
      #  control = self._parent_actor.vehicle.get_control()
        control = self.ego_vehicles.get_control()
       # speed_limit = self._parent_actor.vehicle.get_speed_limit() / 3.6 * 0.8
        speed_limit = self.ego_vehicles.get_speed_limit() / 3.6 * 0.8
        obs = {
