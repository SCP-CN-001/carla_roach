...
class AutonomousAgent(object):
    ...
    def __call__(self):
        ...
        #开始渲染
# [Agent] -- Wallclock = 2024-07-08 18:56:52.216 -- System time = 0.000 -- Game time = 0.050 -- Ratio = 0.000x
        control = self.run_step(input_data, timestamp)  #就是这个run_step貌似就是那个控制自车运动和交互的函数，只是不同的算法给的动作不同。
