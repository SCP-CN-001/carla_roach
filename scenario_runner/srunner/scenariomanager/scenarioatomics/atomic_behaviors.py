...
import carla
import sys
# add Carla0.9.14 function
sys.path.append(os.getenv('Carla_root') + "PythonAPI/")
...
import sys
sys.path.append(os.getenv('SCENARIO_RUNNER_ROOT'))
...
class ConstantVelocityAgentBehavior(AtomicBehavior):
    ...
    def initialise(self):
        """Initialises the agent"""
        self._agent = ConstantVelocityAgent(
            vehicle=self._actor, target_speed=self._target_speed * 3.6, opt_dict=self._opt_dict,
            map_inst=CarlaDataProvider.get_map(), grp_inst=CarlaDataProvider.get_global_route_planner())
...
class AdaptiveConstantVelocityAgentBehavior(AtomicBehavior):
    ...
    def initialise(self):
        ...
        self._agent = ConstantVelocityAgent(vehicle=self._actor, target_speed=target_speed, opt_dict=self._opt_dict,
